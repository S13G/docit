    ...
    module ProductsDocs
      ...
      doc :index do
        ...
        response 200, "Products retrieved successfully" do
          property :products, type: :array do
            ...
            property :price, type: :float, example: 29.99
        ...
        response 500, "Internal server error" do
          property :error, type: :string, example: "Failed to retrieve products"
        end
      end

      doc :create do
        summary "Create a new product"
        description "Creates a new product with the given attributes"
        tags "Products"

        request_body required: true do
          property :name, type: :string, required: true, example: "New Product"
          property :price, type: :float, required: true, example: 19.99
        ...
        response 201, "Product created successfully" do
          ...
          property :price, type: :float, example: 19.99
      ...
      doc :update do
        ...
        request_body required: true do
          ...
          property :price, type: :integer, example: 39
        end
        ...
        response 200, "Product updated successfully" do
          ...
          property :name, type: :string, example: "Updated Widget"
          property :price, type: :integer, example: 39
          property :updated_at, type: :string, example: "2022-01-01T12:00:00Z"
        end
      ...
      doc :destroy do
        ...
        response 500, "Internal server error" do
          property :error, type: :string, example: "Failed to delete product"
        end
      end
    end
  end
