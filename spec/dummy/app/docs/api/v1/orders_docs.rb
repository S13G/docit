    ...
    module OrdersDocs
      ...
      doc :cancel do
        ...
        response 200, "Order cancelled successfully" do
          ...
          property :cancelled_at, type: :string, example: "2022-01-01T12:00:00Z"
        end
      ...
      doc :index do
        ...
        description "Returns a list of orders with their status and total"
        tags "Orders"
      ...
      doc :create do
        ...
        request_body required: true do
          property :total, type: :number, required: true, example: 79.98
        end
      ...
      doc :show do
        ...
        description "Fetches an order with the given ID"
        tags "Orders"
